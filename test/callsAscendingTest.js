...
var callsAscending = require('../modules/callsAscending');
...
describe('return calls in ascending order', function(){
  it('should return the list of mtn call in ascending order', function(done){
    ...
    var callList = callDuration.calculateDuration(specifies);
  ...
  assert.deepEqual(callsAscending.sortInAscOrder(callList), results);
  done();
  });
